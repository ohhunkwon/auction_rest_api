...
--
-- Host: localhost:8889
-- Generation Time: Nov 30, 2021 at 06:41 PM
...
CREATE TABLE `Items` (
  ...
  `auctionStatus` enum('active','inactive') DEFAULT 'active',
...
(11, '42 inch TV', 'adasdfewfwe', 'Electronics', '400', '500', '2021-10-22 07:01:07', '2021-10-24 08:01:08', 'image.png', 1, 1, 500, 'inactive', 3),
(12, 'Parka Coat', 'savasd sdf dsa fs s', 'Fashion', '50', '60', '2021-10-22 07:02:29', '2021-10-28 08:02:30', 'image.png', 2, 22, 1505, 'inactive', 3),
...
(20, 'This is going to be bidded', 'asdfnsdasdaa adjkva vv', 'Sports', '15', '20', '2021-12-23 10:00:00', '2021-12-29 08:00:30', 'image.jpg', 15, 30, 200, 'inactive', 16),
